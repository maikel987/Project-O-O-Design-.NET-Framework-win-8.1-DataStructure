...
{
    public class JournalLib : AbstractItem
    {
        public JournalLib(Guid ISBN, double price, string title, DateTime EditionDate, Categorie subject, int stock = 0, decimal discount = 0, BitmapImage image = null) 
